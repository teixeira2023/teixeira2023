 ...
 */
var getUserBlockedAccountIds = /*#__PURE__*/function () {
  var _ref = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(authorization, options) {
    var url, response, _response$error$messa, _response$error;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          url = buildRequestUrl(USER_BASE_URL, "/:accountId/blocks", options, {
            accountId: "me" // 'me' is used to refer to the authenticated user's account
          });
          _context.next = 3;
          return call({
  ...
  return function getUserBlockedAccountIds(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
exports.getPurchasedGames = getPurchasedGames;
...
exports.getUserBlockedAccountIds = getUserBlockedAccountIds;
exports.getUserFriendsAccountIds = getUserFriendsAccountIds;
exports.getUserFriendsRequests = getUserFriendsRequests;
